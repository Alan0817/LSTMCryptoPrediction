...
FINANCIAL_DOCUMENT_SEARCH_PARAMETERS = {
    ...
    "properties": {
        ...
        "section": {
            "type": "string",
            "description": "Optional exact filing section identifier or section title, case-insensitive.",
            "minLength": 1,
        },
        "filing_date_from": {
            "type": "string",
            "format": "date",
            "description": "Optional inclusive SEC filing date in YYYY-MM-DD, not a financial reporting period.",
        },
        "filing_date_to": {
            "type": "string",
            "format": "date",
